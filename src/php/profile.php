...
file_put_contents($image_path,base64_decode($obj['image']));
$image_path="php/".$image_path;



$sql = "UPDATE `user` SET `username`='{$obj['username']}',`firstname`='{$obj['firstname']}',`lastname`='{$obj['lastname']}',`bio`='{$obj['bio']}', `image`='{$image_path}' WHERE iduser = '{$_SESSION['unique_id']}'";
